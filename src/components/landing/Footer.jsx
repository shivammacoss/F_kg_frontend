      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6 text-[12px] leading-[1.6]">
            ...
            <p>
              Forex KG Europe, UAB ("B4X" or "Forex KG") (company code: 306377915) is authorized and regulated by the Bank of Lithuania ("BoL") as a financial brokerage firm and a crypto-asset service provider. B4X is an affiliated entity and wholly owned subsidiary of Forex KG Markets, Inc. ("Parent Company"). B4X's registered address is: Vilniaus g. 33-201, LT-01402 Vilnius, Lithuania.
            </p>
            <p className="font-mono">5070830</p>
            <p>
              Forex KG Markets, Inc. © 2025 Forex KG. All rights reserved.
            </p>
          </div>
        </div>
